...
paths = ['CETperceptual_csv_0_1', 'CETperceptual_csv_0_1_v2', 'CETperceptual_csv_0_1_v3', 'Glasbey']
        ...
        for name in [n for n in names]:
            for k, v in d.items():
                ...
                for alias in v:
                    ...
                    if name == k and alias not in names:
                        if v_position == -2:
                            names.append(alias)
                        else:
...
aliases = dict(
    circle_mgbm_67_c31                              = ['cyclic_isoluminant', 'colour'],
    cyclic_grey_15_85_c0                            = ['cyclicgrey'],
    cyclic_mygbm_30_95_c78                          = ['phase4'],
    cyclic_mygbm_30_95_c78_s25                      = ['colorwheel'],
    cyclic_wrwbw_40_90_c42                          = ['phase2'],
    diverging_bkr_55_10_c35                         = ['bkr'],
    diverging_bky_60_10_c30                         = ['bky'],
    diverging_bwg_20_95_c41                         = ['bwg'],
    diverging_bwr_20_95_c54                         = ['bwra'],
    diverging_bwr_40_95_c42                         = ['bwr', 'coolwarm'],  # mpl
    diverging_gkr_60_10_c40                         = ['gkr'],
    ...
    diverging_rainbow_bgymr_45_85_c67               = ['rainbow3'],
    ...
    linear_gow_60_85_c27                            = ['geographic'],
    ...
    linear_ternary_green_0_46_c42                   = ['greenternary', 'kg'],
    linear_ternary_red_0_50_c52                     = ['redternary', 'kr'],
    linear_wcmr_100_45_c42                          = ['wcmr'],
    linear_worb_100_25_c53                          = ['worb'],
    linear_wyor_100_45_c55                          = ['wyor'],
    rainbow_bgyr_10_90_c83                          = ['rainbow4'],
    rainbow_bgyr_35_85_c72                          = ['rainbow2'],
...
mapping = {
    ...
    'CET-C3': 'cyclic_wrkbw_10-90_c43',
    'CET-C3s': 'cyclic_wrkbw_10-90_c43_s25',
    ...
    'CET-C6': 'cyclic_rygcbmr_50-90_c64',
    'CET-C6s': 'cyclic_rygcbmr_50-90_c64_s25',
    'CET-C7': 'cyclic_ymcgy_60-90_c67',
    'CET-C7s': 'cyclic_ymcgy_60-90_c67_s25',
    'CET-C8': 'cyclic_mygbm_50-90_c46',
    'CET-C8s': 'cyclic_mygbm_50-90_c46_s25',
    'CET-C9': 'cyclic_mybm_20-100_c48',
    'CET-C9s': 'cyclic_mybm_20-100_c48_s25',
    'CET-C10': 'circle_mgbm_67_c31',
    'CET-C10s': 'circle_mgbm_67_c31_s25',
    'CET-C11': 'cyclic_bgrmb_35-70_c75',
    'CET-C11s': 'cyclic_bgrmb_35-70_c75_s25',
    ...
    'CET-CBD2': 'diverging-linear-protanopic-deuteranopic_bjy_57-89_c34',
    'CET-CBL1': 'linear-protanopic-deuteranopic_kbjyw_5-95_c25',
    'CET-CBL2': 'linear-protanopic-deuteranopic_kbw_5-98_c40',
    'CET-CBL3': 'linear-protanopic-deuteranopic_kbw_5-95_c34',
    'CET-CBL4': 'linear-protanopic-deuteranopic_kyw_5-95_c49',
    ...
    'CET-CBTL3': 'linear-tritanopic_kcw_5-95_c22',
    'CET-CBTL4': 'linear-tritanopic_krw_5-95_c46',
    ...
    'CET-D5': 'diverging_gkr_60-10_c40',
...
with open(output_file, "w") as output:
    ...
    output.write(format_dict("mapping_flipped", mapping_flipped))
    for path in paths:
