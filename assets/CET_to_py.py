...
same methods described above and are named:
  ...
  glasbey_<starting_palette>_start_[_no_black<if_no_black>]
...
aliases = dict(
  ...
  glasbey_white_start_no_black           = 'Category',
  glasbey_category10_start_no_black     = 'Category10',  #bokeh
  glasbey_category20_start_no_black     = 'Category20',  #bokeh
)
